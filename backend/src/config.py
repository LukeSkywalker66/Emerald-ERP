...
ORACULO_INFLUX_RESUMEN_MEASUREMENT = os.getenv("ORACULO_INFLUX_RESUMEN_MEASUREMENT", "netflow")
ORACULO_INFLUX_IN_BYTES_FIELD = os.getenv("ORACULO_INFLUX_IN_BYTES_FIELD", "download_bytes_sum")
ORACULO_INFLUX_OUT_BYTES_FIELD = os.getenv("ORACULO_INFLUX_OUT_BYTES_FIELD", "upload_bytes_sum")
ORACULO_INFLUX_RESUMEN_IP_TAG = os.getenv("ORACULO_INFLUX_RESUMEN_IP_TAG", "ip_cliente")
ORACULO_INFLUX_ROUTER_PUB_TAG = os.getenv("ORACULO_INFLUX_ROUTER_PUB_TAG", "router_pub")
