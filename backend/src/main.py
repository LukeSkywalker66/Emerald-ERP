...
from src.routers import tickets, search, tags, work_orders, inventory, engineering, coordination
...
# Engineering/NOC Module
app.include_router(
    engineering.router,
    tags=["Engineering/NOC"]
)

# Coordination Module (Teams)
app.include_router(
    coordination.router,
    tags=["Coordination"]
)
